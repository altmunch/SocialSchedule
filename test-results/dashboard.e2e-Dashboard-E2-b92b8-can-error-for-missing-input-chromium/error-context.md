...
- Name: Dashboard E2E >> should handle scan error for missing input
- Location: C:\Users\Cheem\OneDrive\Coding\clipsCommerce\e2e\dashboard.e2e.spec.ts:50:7
...
Call log:
  - waiting for locator('input#niche')

    at C:\Users\Cheem\OneDrive\Coding\clipsCommerce\e2e\dashboard.e2e.spec.ts:52:16
```
