        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            ...
            <Link href="/dashboard" passHref>
              <motion.button
                className="bg-[#A860B7] hover:bg-[#A860B7]/90 text-white px-10 py-5 rounded-lg font-bold text-lg shadow-xl shadow-[#A860B7]/30 transform transition-all"
                whileHover={{ scale: 1.02, boxShadow: '0 10px 25px -5px rgba(168, 96, 183, 0.5)' }}
                whileTap={{ scale: 0.98 }}
              >
